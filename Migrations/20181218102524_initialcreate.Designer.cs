...
namespace ckl.Migrations
{
    ...
    [Migration("20181218102524_initialcreate")]
            ...
            modelBuilder.Entity("ckl.Models.HoroscropeReading", b =>
                {
                    ...
                    b.HasOne("ckl.Models.UploadFile")
                        .WithOne("Horoscrope")
                        .HasForeignKey("ckl.Models.HoroscropeReading", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ckl.Models.Newsletter", b =>
                {
                    ...
                    b.HasOne("ckl.Models.UploadFile")
                        .WithOne("Newsletter")
                        .HasForeignKey("ckl.Models.Newsletter", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ckl.Models.SaturnReport", b =>
                {
                    ...
                    b.HasOne("ckl.Models.UploadFile")
                        .WithOne("SaturnReport")
                        .HasForeignKey("ckl.Models.SaturnReport", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
