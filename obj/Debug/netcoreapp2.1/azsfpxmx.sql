...
ALTER TABLE [UserCustomerAssociations] ALTER COLUMN [UserId] int NULL;
...
ALTER TABLE [UserCustomerAssociations] ALTER COLUMN [UCRoleId] int NOT NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20181107174016_userCustAssocsc', N'2.1.4-rtm-31024');
